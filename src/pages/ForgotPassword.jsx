...
const ForgotPassword = () => {
  ...
  const handleReset = async (e) => {
    ...
    try {
      const response = await fetch(`${import.meta.env.VITE_API_URL}/auth/force-reset`, {
        method: 'POST',
    ...
    <main className="flex-grow flex items-center justify-center p-4">
      <div className="w-full max-w-md bg-white p-10 rounded shadow-[0_4px_24px_-4px_rgba(44,44,44,0.08)] border border-[#E5E0D8]">
        ...
        <div className="text-center mb-8">
          <h2 className="text-3xl font-bold text-[#2C2C2C] mb-2">Reset Password</h2>
          <p className="text-[#8E7C68] italic font-serif">Enter your email and new password</p>
        </div>
