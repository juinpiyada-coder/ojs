...
const EditorDashboard = () => {
  ...
  const [doubleBlindMode, setDoubleBlindMode] = useState(true);
  ...
  const filteredArticles = articles.filter(art => {
    ...
    // Scope filter (Assigned to Me vs Unassigned vs All)
  ...
  return (
    <div className="space-y-8">
      ...
      {/* 1. Header & Anonymity Mode Toggle */}
              ...
              {loading ? (
                ...
                filteredArticles.map(article => (
                  <tr key={article.article_id} className="hover:bg-gray-50 transition-colors">
                    ...
                    {/* Author (Redacted in Double-Blind Review) */}
      ...
      {/* 5. Editorial Action & Status Management Modal */}
      {managingArticle && (
          ...
          <div className="bg-white rounded-xl max-w-3xl w-full p-6 sm:p-8 shadow-lg border border-gray-200 my-8 animate-scaleUp max-h-[92vh] overflow-y-auto">
            ...
            <form onSubmit={handleSaveEditorialAction} className="space-y-6 pt-5">
              ...
              <div className="bg-blue-50/50 p-5 rounded-2xl border border-blue-200 space-y-4">
                ...
                {/* Existing Reviews Summary with Detailed Comments (Reviewer Identity Shielded) */}
              ...
              <div className="flex justify-end gap-3 pt-4 border-t border-gray-100">
                ...
                >
                  {submitting ? 'Saving Changes...' : 'Save Editorial Decision & Update Workflow'}
                </button>
              </div>
      ...
      {/* 6. Document Viewer Modal with Double-Blind Author Redaction Overlay */}
      {viewingDoc && (
        <div className="fixed inset-0 bg-black/80 backdrop-blur-md flex items-center justify-center z-[100] p-4 sm:p-6 animate-fadeIn">
          <div className="bg-white rounded-xl shadow-lg w-full max-w-5xl h-[90vh] flex flex-col relative overflow-hidden border border-gray-200">
            ...
            {/* Header with Redaction Controls */}
              ...
              <div>
                <div className="flex items-center gap-2 mb-0.5">
                  <span className="px-2 py-0.5 bg-amber-400/20 text-amber-300 rounded text-[10px] font-bold flex items-center gap-1">
                    <FaFilePdf /> Manuscript Preview
                  </span>
                  <span className="text-xs text-gray-400 font-mono">ID #{viewingDoc.id}</span>
                  <span className="px-2 py-0.5 bg-emerald-500/20 text-emerald-300 rounded text-[10px] font-bold flex items-center gap-1">
                    <FaShieldAlt /> Double-Blind Anonymized
                  </span>
                </div>
                ...
                <p className="text-[11px] text-amber-300/90 font-medium">
                  Author(s): [Identity Shielded under Double-Blind Peer Review Protocol]
                </p>
              </div>
      ...
      {/* 7. Interactive LaTeX & Equation Source Editor with Double-Blind Anonymizer */}
      <LatexEditorModal
